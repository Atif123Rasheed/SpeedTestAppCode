package com.leeddev.speedtestappcode;
                        ...
                        try {
                            ...
                            runOnUiThread(() -> {
                              //  tickProgressMeasure.setmPUnit(sharedPref.getString("UNIT", "Mbps"));
                                setmPUnit(sharedPref.getString("UNIT", "Mbps"));
                        ...
                        setmPUnit(sharedPref.getString("UNIT", "Mbps"));
                            switch (sharedPref.getString("UNIT", "Mbps")) {
                                case "MBps":
                                    ...
                                    setProgress((int) (0.125 * downloadTest.getInstantDownloadRate() * 100));
                                    break;
                                case "kBps":
                                    ...
                                    setProgress((int) (125 * downloadTest.getInstantDownloadRate() * 100));
                                    break;
                                case "Mbps":
                                    ...
                                    setProgress((int) (downloadTest.getInstantDownloadRate() * 100));
                                ...
                                case "kbps":
                                    ...
                                    setProgress((int) (1000 * downloadTest.getInstantDownloadRate() * 100));
                                    break;
                                default:
                                    break;
                            }
                        ...
                        runOnUiThread(() -> {
                            ...
                            switch (sharedPref.getString("UNIT", "Mbps")) {
                                case "MBps":
                                    ...
                                    setProgress((int) (0.125 * uploadTest.getInstantUploadRate() * 100));
                                    break;
                                case "kBps":
                                 ...
                                 //   tickProgressMeasure.setProgress((int) (125 * uploadTest.getInstantUploadRate() * 100));
                                    setProgress((int) (125 * uploadTest.getInstantUploadRate() * 100));
                                ...
                                case "Mbps":
                                    ...
                                    setProgress((int) (uploadTest.getInstantUploadRate() * 100));
                                    break;
                                case "kbps":
                                    ...
                                    setProgress((int) (1000 * uploadTest.getInstantUploadRate() * 100));
